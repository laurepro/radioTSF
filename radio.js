function Radio (uuid, database, stored, player) 
{
    ...
    this.loadFavicon = function()
    {
        ...
        dl.Download(this.data.favicon, image_directory, this.data.uuid);

    }
    this.setAction = function(objet) 
    {
        objet.radio = this;
        objet.SetOnTouchDown(function(e){this.radio.onTouchDown(e);});
        objet.SetOnTouchMove(function(e){this.radio.onTouchMove(e);});
        objet.SetOnTouchUp(function(e){this.radio.onTouchUp(e);});
        objet.SetOnLongTouch(function(e){this.radio.onLongTouch(e)});
    }

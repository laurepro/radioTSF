function Player(headset, mediacom) {
    ...
    this.getGui = function() {
        ...
        this.media.SetOnReady(function() {
            ...
            if (self.headset.GetHeadsetState()) {
                if(self.mediacom) self.mediacom.SendAvrcpMeta(self.radio.data.name);
    ...
    this.startPlay = function() {
        ...
        if (this.radio) {
            //---------------------------------- AVRCP meta
            if (this.mediacom) this.mediacom.SendAvrcpMeta(i18n.text('loading') + " ... " + this.radio.data.name);
    ...
    this.signalStop = function() {
        ...
        if (this.headset.GetHeadsetState() && this.player.IsReady()) {
            if (this.mediacom) this.mediacom.SendAvrcpMeta(i18n.text('lost') + " ... " + this.radio.data.name);
